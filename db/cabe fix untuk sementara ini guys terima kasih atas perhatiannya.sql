...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2015 at 04:26 PM
...
CREATE TABLE IF NOT EXISTS `harga_petani` (
  ...
  `tanggal` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT 'CURRENT_DATE'
...
(201, 3, 1, '123132', 123213, NULL),
(202, 1, 1, '12000', 123123123, NULL),
...
(1, '+6285748409235', 'hilman', 1101020),
(2, '234', 'oka', 1304100);
...
('huawei', '2015-08-17 14:25:55', '2015-08-17 14:24:22', '2015-08-17 14:26:05', 'yes', 'yes', '863959022211869', 'Gammu 1.33.0, Windows Server 2007, GCC 4.7, MinGW 3.11', 60, 54, 1, 0);
