...
class inputHarga extends CI_Controller {
	...
	public function index()
	{
      ...
      //  $data['alert']= '<script> $(function(){ setTimeout(function(){$.Notify({type: \'success\', caption: \'Success\', content: "Metro UI CSS is Sufficient!!!"}); }, 2000);     });  </script>';
        ...
        $data['provinsi'] = $this->m_inputHarga->get_provinsi();
    ...
    public function getKabKota() {
        ...
        $data['kk'] = $this->m_inputHarga->get_kabkota($id_prov);
        $output = null;
    ...
    public function getKec() {
        ...
        $data['k'] = $this->m_inputHarga->get_kecamatan($id_kabkota);
        $output = null;
    ...
    public function getTitik() {
        ...
        $data['kkk'] = $this->m_inputHarga->get_titik($id_kecamatan);
        $output = null;
